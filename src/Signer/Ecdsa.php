...
abstract class Ecdsa extends BaseSigner
{
    ...
    public function __construct(
        GmpMathInterface $mathInterface = null,
        EccAdapter $adapter = null,
        KeyParser $keyParser = null
    ) {
        $mathInterface = $mathInterface ?: EccFactory::getAdapter();

        $this->adapter = $adapter ?: new EccAdapter($mathInterface);
        $this->keyParser = $keyParser ?: new KeyParser($mathInterface);
    }
